...
- [ ] If the template mentions another workflow / skill / agent by name, verify
      the referenced capability is Trellis-native and available in generated
      output on a clean npm-installed machine
- [ ] Grep sibling agent / review / hook templates for the same behavior text;
      runtime portability bugs often survive outside the main workflow file
