...
describe("sameProject", () => {
  ...
  it("treats Windows path casing as equivalent", () => {
    if (process.platform !== "win32") return;
    expect(
      sameProject(
        "D:\\Trellis\\Trellis-0.6.0-beta.17\\packages\\mem-int-project",
        "d:\\trellis\\Trellis-0.6.0-beta.17\\packages\\mem-int-project",
      ),
    ).toBe(true);
  });
});
